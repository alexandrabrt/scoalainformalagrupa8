...
# print(5 ** 2)  # ridicarea la putere

# print(5 == 2)  # operator de egalitate => returneaza un boolean (True 1 sau False 0)
# print(5 != 2)  # operator de diferentiere => returneaza un boolean (True 1 sau False 0)
# print(5 > 2)
# print(5 < 2)
# print(5 >= 2)
# print(5 <= 2)
...
# print(5 > 2 or 3 > 1)  # operator login sau
...
# my_var, my_var_1 = 0, 1
# my_var = 3
# my_var = my_var + 1  # asignare prin adunare / incrementare
# my_var += 1
# my_var *= 2  # asignarea prin inmultire
# print(my_var)
...
# varsta = 20
# inaltime = 1.65
# prezentare = "Numele meu este {1} si prenumele este {0}".format(nume, prenume)
...
# prezentare = "Numele meu este {0} si prenumele este {1} si varsta este {2}".format(nume, prenume, varsta)
